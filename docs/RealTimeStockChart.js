...
// 	stockChart.xAxis.title = "Tempo";
// 	stockChart.yAxis.title = "Fechamento";
...
// 	{
// 		$.getJSON("https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=AAPL&interval=5min&apikey=demo", function(json) {
